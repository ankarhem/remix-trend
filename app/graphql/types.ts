...
export type ContentPageFragment = { name: string, mainHeader?: string | null, content?: string | null, pageId: string, primaryRoute?: { id: string, path: string } | null, images?: Array<{ url?: any | null } | null> | null, data?: { id: string, items?: Array<{ type: string, properties?: Array<{ name: string, type: string, valueType?: ContentPropertyValueType | null, value?: { value?: string | null } | {} | null } | null> | null } | null> | null } | null, parent?: { id: string, name: string, primaryRoute?: { id: string, path: string } | null, subPages?: Array<{ id: string, name: string, primaryRoute?: { id: string, path: string } | null }> | null } | null, subPages?: Array<{ id: string, name: string, primaryRoute?: { id: string, path: string } | null }> | null };
